@echo off
color 4
title Tqeqz reaper Pinger
echo =====================================================
echo WELCOME TO TQEQZ REAPER PINGER. 
echo =====================================================
echo                ...
echo              ;::::;
echo           ;::::; :;
...
echo    ::::::`:::::;'  /  /   `#
echo.
echo pssssst type "ily" to search your targets ip info!
echo.
echo.
:hub
set /p var=Enter IP~
if %var%==ily goto iplook
